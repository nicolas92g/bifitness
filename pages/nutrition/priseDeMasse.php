...
<div class='pageTextContainer'>
    <section>
        <h2 class='borderBottom'>Prise de masse</h2>
        <p>
            Pour une bonne prise de masse, il est
            essentiel de respecter certaines règles
            de base.
            Voici mes conseils pour une prise de masse
            réussie :
        </p>
        <ol>
            <li>
    ...
    <section class='borderTop'>
        ...
        <button onclick='alert(\"TODO!\")'>je veux prendre de la masse</button>
    </section>
</div>
