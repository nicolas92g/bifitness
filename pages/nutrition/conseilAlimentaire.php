...
<div class='pageTextContainer'>
    <section>
        <h2 class='borderBottom'>Conseils alimentaires</h2>
        <p>
            Pour une avoir une bonne alimentation il est
            essentiel de respecter certaines règles
            de base.
            Voici mes conseils pour avoir une bonne alimentation :
        </p>
        <ol>
            <li>
